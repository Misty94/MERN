...
const badHabit4 = "hoards snacks";
const expected4 = ["Roger Anderson"];
...
console.log(santasNaughtyList(students, badHabit4));
...
console.log(santasNaughtyListFunctional(students, badHabit4));

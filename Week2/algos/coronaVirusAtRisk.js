...
//             // persons[i]['friends']
//             for (let j = 0; j < persons.friends.length; j++){
//                 let riskyFriend = persons[i].Object.entries();
//                 if (riskyFriend.hasCovid === true){
//                     results.push(persons[i]);
//                 }
//                 else if (riskyFriend.isSocialDistancing === false){
//                     results.push(persons[i]);
//                 }
//             }
//         }
...
console.log(coronaVirusAtRiskFunctional2(people))
